    ...
    <body>
	 ...
	 <?php include'header.php' ?>
      ...
      <br>
        ...
        <input class="login-btn" type="submit" name="staff_login-btn" value="LOGIN"/>
        <!-- <input class="login-btn" type="submit" name="staff_login-btn" value="LOGIN WITH GOOGLE"/>
        <input class="login-btn" type="submit" name="staff_login-btn" value="FACE LOGIN"/> -->
        <br>
